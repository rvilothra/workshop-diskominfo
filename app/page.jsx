    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
        <div className="text-center mb-8 max-w-xl mx-auto">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 tracking-tight leading-tight mb-3">
            Selamat Datang di Portal Layanan Publik Kabupaten Bogor
          </h1>
          <p className="text-gray-600 text-sm sm:text-base md:text-lg leading-relaxed">
            Nikmati kemudahan layanan publik secara online, cepat, mudah, dan transparan.
          </p>
        </div>
